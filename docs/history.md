...
graph TD
    ...
    C --> D[05_webui/backend/main.py: sanitize_history]
    D -->|Sanitized History List| E[05_webui/backend/llm_router.py: classify_query_intent]
    ...
    N --> O[05_webui/backend/main.py: build_condensed_history]
    ...
    R --> T[05_webui/backend/llm_router.py: verify_answer_grounding]
...
### A. Frontend Storage (`05_webui/frontend/src/App.jsx`)
...
### B. Backend Sanitization (`05_webui/backend/main.py`)
...
### A. The Classifier (`05_webui/backend/llm_router.py`)
...
* **File**: [main.py](file:///c:/Users/hp/Desktop/sewa%20setu%20copies/SewaSetuRag%20-%20Copy%20(2)/05_webui/backend/main.py)
...
* **File**: [llm_router.py](file:///c:/Users/hp/Desktop/sewa%20setu%20copies/SewaSetuRag%20-%20Copy%20(2)/05_webui/backend/llm_router.py)
