...
EXTRACTED_TEXT_DIR = os.path.join(WORKSPACE_DIR, "01_preprocessing", "data", "extracted_text")
OCR_DIR = os.path.join(WORKSPACE_DIR, "01_preprocessing", "data", "ocr_output")
CHUNKS_OUT_PATH = os.path.join(WORKSPACE_DIR, "04_embeddings_and_kg", "data", "chunks.json")
